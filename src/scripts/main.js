...
outEl.innerHTML += "<h1>Active Business</h1?"
...
// Array to contain all the New York businesses this also contains an example of the filter function that also iterates through filter to display only the business that has matching values. Also includes an implicit return for the array
